      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-12">
          <div>
            ...
            <p className="text-pro-400 text-sm leading-relaxed">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link to="/catalog" className="text-pro-400 hover:text-gold-400">Catalogue</Link></li>
              <li><Link to="/cart" className="text-pro-400 hover:text-gold-400">Panier</Link></li>
              <li><a href="https://wa.me/c/22954099154" target="_blank" rel="noopener noreferrer" className="text-pro-400 hover:text-gold-400">Catalogue WhatsApp</a></li>
            </ul>
          </div>
          <div>
            <h3 className="text-white font-semibold mb-4">Coordonnées</h3>
            <ul className="space-y-3 text-sm">
              <li className="flex items-start gap-2 text-pro-400">
                <MapPin size={16} className="mt-0.5 text-gold-400 shrink-0" />
                <span>Bénin, Cotonou – Quartier résidentiel</span>
              </li>
              <li className="flex items-center gap-2 text-pro-400">
        ...
        <div className="border-t border-navy-700 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-pro-400 text-sm">© {new Date().getFullYear()} CM Group Sarl. Tous droits réservés.</p>
          <p className="text-pro-400 text-sm">Conçu pour le marché béninois</p>
        </div>
      </div>
    </footer>
  );
